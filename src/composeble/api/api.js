...
const getTours = async function () {
    ...
    const data = await axios.get(store.getters.getUrl + 'tours')
...
export {logout, registration, login, getCatalog, addToCart, getCart, deleteFromCart, createOrder, getOrders, getTours}